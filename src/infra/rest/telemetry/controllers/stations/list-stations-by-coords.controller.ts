...
import { ListStationsByCoordsUseCase } from "@/core/telemetry/use-cases/list-stations-by-coords-use-case"
...
class ListStationsByCoordsControllerRequestQuery extends createZodDto(cursorListingSchema) {}
